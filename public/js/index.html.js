...
onAppReady(function(param) {
	...
	if(flg==1){
	    ...
	    function(rs) {
	    	...
	    	var  e='<table border="4" id="student_table" bgcolor="#FFE7CE" bordercolor="#DC143C">';
	    	...
	    	for(i =0;i<row_max;i++)
	    	{
	    		...
	    		for(j =0;j<col_max;j++)
	    		{
	    			...
	    			else
	    			{
	    				...
	    				//e=e+'<td data-id="'+seq_cols[j]+'"class="white_par">'+name_cols[j]+'</td>';
	    			}
	    		}
	    		e=e+'</tr>';
	    	}
    ...
    */
	...
	(function() {
		...
		socket.on('next', function(command){
			...
			//背景画像の設定
			var div = document.getElementById("chalkboard");
			div.style.background = "url(../images/div/kokuban.jpg)";
