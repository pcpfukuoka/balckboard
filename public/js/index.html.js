...
onAppReady(function(param) {
	...
	if(flg==1){
	    ...
	    function(rs) {
	    	...
	    	var  e='<table border="4" align="center" bgcolor="#FFE7CE" bordercolor="#DC143C" style="position: absolute; left: 100px; top: 45%">';
	    	...
	    	for(i =0;i<row_max;i++)
	    	{
	    		...
	    		for(j =0;j<col_max;j++)
	    		{
	    			...
	    			{
	    				//通常の座席の処理
	    				e=e+'<td><img src="../images/kokuban.jpg" data-id="'+seq_cols[j]+'"class="white_par" width="30" height=""></td>';
